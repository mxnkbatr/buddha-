...
export function TourCardSkeleton() {
    return (
        <View className="bg-white rounded-xl mb-4 mx-4 shadow-sm overflow-hidden">
            <View style={{ width: '100%', height: 180, backgroundColor: '#E7E5E4' }} />
            <View className="p-4">
                <Skeleton width={250} height={18} className="mb-2" />
                <Skeleton width={280} height={14} className="mb-2" />
